...
logger.log('info',"username", process.env['CONVERSATION_USERNAME']);
logger.log('info',"password", process.env['CONVERSATION_PASSWORD']);
logger.log('info',"acesstoken",process.env['FB_ACCESS_TOKEN']);
logger.log('info',"spaceod", process.env['WORKSPACE_ID']);
